      ...
      <Grid container>
        ...
        <Grid item xs={12} style={{ textAlign: "center" }}>
          <Typography className={classes.thanks}>
            A bajillion thanks to my wonderful little family for putting up with
            me, my instructors and everyone at Prime for the endless
            encouragement, my cohort mates for the late night coding parties,
            Jeff Rutland and Tyler Jorenby for the their veteran wisdom, Crypto
            Jebb and his team for the companionship on weekdays between 8:30 and
            9:30 AM, the fine folks at Coingecko for providing an awesome API,
            and my absolutely perfect fiancée Sharesa (almost) Mochinski for
            holding down the fort and being the most incredible human ever.{" "}
          </Typography>
        </Grid>
